...
baseline_dir = '/users/deepmish/scarab/src/baseline_apt_get'
ideal_fusion_dir = '/users/deepmish/scarab/src/ideal_fusion_apt_get'
...
for app in common_apps:
    base_path = os.path.join(baseline_dir, app, 'output.txt')
    ideal_path = os.path.join(ideal_fusion_dir, app, 'output.txt')
...
# Save and show
plt.tight_layout()
plt.savefig('ipc_comparison_apt_get.png', dpi=300, bbox_inches='tight', facecolor='white')
plt.show()
...
print("Plot saved as 'ipc_comparison_apt_get.png'")